@UserUpdateProfileUserPos @Automate
Feature: [Positive Case] Update User as User

  Scenario: User Update User with Valid Parameter
    ...
    Then User input "Uchiha Itachi" as new Nama and "saringan@alta.com" as new Email
