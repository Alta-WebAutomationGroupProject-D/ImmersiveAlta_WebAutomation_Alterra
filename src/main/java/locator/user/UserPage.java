...
public class UserPage {
    ...
    @FindBy(className = "//li[@class='cursor-pointer']//div[.='User']")
    ...
    @FindBy(xpath = "//input[@value='naruto@mail.com']")
    ...
    @FindBy(css = "")
    private WebElement failedCreate;
    ...
    public boolean vrfyPopUpAksesDitolak(){
        failedCreate.isDisplayed();
        return true;
    }
